<template>
    <div>
        ...
        style="z-index: 15;">
            ...
            <a @click="openTab('https://www.linkedin.com/in/tony0green')"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 26 26" class="fill-white pointer-events-auto hover:cursor-pointer">
